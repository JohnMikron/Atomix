...
Welcome to Atomix, a Software Transactional Memory (STM) implementation for Python 3.13+. This guide will walk you through the core concepts and modern patterns for using STM effectively.
