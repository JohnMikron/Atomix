"""
Atomix — Regression Test Suite for Locks and Thread Safety
==========================================================
"""
...
class TestSeqLockBoundedSpin(unittest.TestCase):
    """SeqLock.read() should have an upper bound on spin retries."""
...
class TestNotifyWatchersLogging(unittest.TestCase):
    """_notify_watchers should log errors, not silently swallow."""
...
class TestRefDerefCatchesTimeout(unittest.TestCase):
    """Ref.deref() should handle TimeoutException from SeqLock."""
...
class TestSeqLockPublicAPI(unittest.TestCase):
    """SeqLock should expose read_seq() and read_value() public API."""
...
class TestSTMReaperGracefulStop(unittest.TestCase):
    """STMReaper.stop() should join the thread."""
...
class TestRefDelNoBarExcept(unittest.TestCase):
    """Ref.__del__ should use except Exception, not bare except."""
    ...
    def test_ref_del_no_bare_except(self):
        ...
        self.assertEqual(len(matches), 0, "Ref.__del__ still has bare except:")
